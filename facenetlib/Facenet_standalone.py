# Standalone FaceNet implementation without deepface dependencies
import tensorflow as tf
from tensorflow.keras.models import Model
from tensorflow.keras.layers import (
    Activation, BatchNormalization, Concatenate, Conv2D, Dense,
    Dropout, GlobalAveragePooling2D, Input, Lambda, MaxPooling2D, add
)
from tensorflow.keras import backend as K
FACENET512_WEIGHTS = "facenet512_weights.h5"
